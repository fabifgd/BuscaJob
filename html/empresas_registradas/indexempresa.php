...
<html>
  ...
  <body>
    ...
    <div class="row" id="busqueda">
      <div class="col-md-12">
          <div class="row">
              <form action="../consultas_registrados_empresas/consultas_busqueda_ofertas.php" method="get">
          <div class="col-md-5">
    ...
    <div class="row" id="ofertasrecientes1">
      ...
      <div class="container" id="container">
        <?php include("../consultas_registrados_empresas/consulta_ofertas_recientes.php"); ?>
      </div>
