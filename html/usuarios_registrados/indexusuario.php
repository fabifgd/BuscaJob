  ...
  <body>
    ...
    <div class="row" id="busqueda">
      <div class="col-md-12">
          ...
          <div class="col-md-2" id="botonbusqueda">
            <button type="submit" class="btn btn-default" onclick="../consultas_registrados/consultas_busqueda_ofertas.php">Buscar</button>
          </div>
        </form>
      </div>
      </div>
    ...
    <div class="row" id="ofertasrecientes1">
      ...
      <div class="container" id="container">
        <?php include("../consultas_registrados_usuarios/consulta_ofertas_recientes.php"); ?>
      </div>
