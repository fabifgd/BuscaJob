...
require("../datos_conexion.php");
    ...
    $consulta="SELECT * FROM anuncios ORDER BY RAND() LIMIT 9";
    ...
    while (($fila=mysqli_fetch_row($resultados))==true) {
      ...
      echo "<div class='col-md-12' id='cajaoferta' style='height: 10%; margin-bottom: 2%;'>";

      echo "<strong>" . "<p style='font-size: 1.5em;' id='id_usuario'><a href='../usuarios_registrados/anuncio_completo_usuarios.php?id=" . $fila[1]. "'>" . $fila[2] . "</a></p>" . "</strong>";
