      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li><a href="../empresas_registradas/indexempresa.php">Inicio</a></li>
            <li><a href="../empresas_registradas/ofertasempleo.php">Ofertas de Empleo</a></li>
            <li><a href="../empresas_registradas/crearoferta.php">Crear Oferta</a></li>
            <li><a href="../empresas_registradas/ofertas.php">Ofertas</a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li><a><?php echo "Hola " . $_SESSION["nombre_usuario"] . " !"?></a></li>
            <li><a href="../../empresas_registradas/logout.php">Cerrar Sesion</a></li>
          </ul>
        </div>
      </div>
   <?php
    try{
          ...
          if($numero_registro!=0){
            ...
            echo utf8_decode("<strong>" . "<p style='font-size: 1.5em;'><a href='../empresas_registradas/anuncio_completo_empresas.php?id=" . $row["id_anuncio"]. "'>" . $row["nombre_oferta"]. "</a></p>" . "</strong>");
