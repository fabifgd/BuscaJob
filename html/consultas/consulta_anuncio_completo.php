...
while (($fila=mysqli_fetch_row($resultados))==true) {
  ...
  echo "<p id='contacto'>" . "<strong>Contacta con Nosotros: </strong>" . "</p>";

  echo "<p id='email'>" . "<strong>E-Mail: </strong>" . "</p>". "<p>" . $fila[15] . "</p>";

  echo "<p id='telefono'>" . "<strong>Telefono: </strong>" . "</p>". "<p>" . $fila[14] . "</p>";
