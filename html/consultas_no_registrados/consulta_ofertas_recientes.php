...
require("datos_conexion.php");
    ...
    while (($fila=mysqli_fetch_row($resultados))==true) {
      ...
      echo "<div class='col-md-12' id='cajaoferta' style=margin-bottom: 2%;'>";

      echo "<strong>" . "<p style='font-size: 1.5em;' id='id_usuario'><a href='../no_registrados/anuncio_completo.php?id=" . $fila[1]. "'>" . $fila[2] . "</a></p>" . "</strong>";
